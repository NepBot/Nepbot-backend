    ...
    if(msg.content.startsWith('!')){
        ...
        switch (msg.content) {
            case '!verify':
                ...
                let testButton = new MessageButton().setLabel('Connect Near Wallet').setStyle('PRIMARY').setCustomId("vefify")
                ...
                temp.setURL(`${walletAuthUrl}/verify/?user_id=${msg.author.id}&guild_id=${msg.guildId}`)
